...
- (void)update:(CCTime)delta
{
    ...
    for(CCNode *bush in _bushes){
        ...
        //if the left corner of the bush position is one complete width off of the screen, move it to the right side of the screen
    ...
    for (CCNode *cloud in _clouds) {
        //move the clouds in the background
        cloud.position = ccp(cloud.position.x - (character.physicsBody.velocity.x * delta), cloud.position.y);
        
        //if the cloud is off of the screen to the left, move it to the right of the screen
